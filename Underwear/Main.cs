...
namespace StorybrewScripts
{
    ...
    {   
        ...
        public override void Generate()
        {
            ...
            if(Beatmap.Name == "MBStetson's Expert") generateCollab();
            ...
            }))
            {
                foreach(var hitobject in Beatmap.HitObjects)
                {
                    ...
                    (hitobject.StartTime >= 43581 - 5 && hitobject.StartTime < 52506 + 5) ||
                     ...
                     InTime(hitobject.StartTime,53481,53481) || InTime(hitobject.EndTime,53481,53481) ||
                     InTime(hitobject.StartTime,54081,54081) || InTime(hitobject.EndTime,54081,54081) ||
                     InTime(hitobject.StartTime,54681,54681) || InTime(hitobject.EndTime,54681,54681) ||
                     InTime(hitobject.StartTime,55281,55281) || InTime(hitobject.EndTime,55281,55281) ||
                     InTime(hitobject.StartTime,55881,55881) || InTime(hitobject.EndTime,55881,55881) ||
                     InTime(hitobject.StartTime,56481,56481) || InTime(hitobject.EndTime,56481,56481) ||
                     InTime(hitobject.StartTime,57081,57081) || InTime(hitobject.EndTime,57081,57081) ||
                     InTime(hitobject.StartTime,57681,57681) || InTime(hitobject.EndTime,57681,57681) ||
                     InTime(hitobject.StartTime,58281,58281) || InTime(hitobject.EndTime,58281,58281) ||
                     InTime(hitobject.StartTime,58881,58881) || InTime(hitobject.EndTime,58881,58881) ||
                     InTime(hitobject.StartTime,59481,59481) || InTime(hitobject.EndTime,59481,59481) ||
                     InTime(hitobject.StartTime,60081,60081) || InTime(hitobject.EndTime,60081,60081) ||
                     InTime(hitobject.StartTime,60081,60081) || InTime(hitobject.EndTime,60081,60081))
                    )
                    {
        ...
        void generateBackground()
        {
            ...
            blurBg.Scale(0,854.0f/1529);
            blurBg.Fade(0,0);
            blurBg.Fade(390,0.6);
            blurBg.Fade(9990,0);

            var bwBG = GetLayer("").CreateSprite("sb/bwBG.jpg");
            bwBG.Scale(0,854.0f/1529);
            bwBG.Fade(0,0);
            bwBG.Fade(9990,0.45);
            bwBG.Fade(19590,0.6);
            bwBG.Fade(26781,0);
            ...
            var noGirl = GetLayer("").CreateSprite("sb/noGirl.jpg");
            noGirl.Scale(0,854.0f/1529);
            noGirl.Fade(0,0);
            noGirl.Fade(29181,1);
            ...
            var girl = GetLayer("").CreateSprite("sb/girl.png",OsbOrigin.Centre,new Vector2(380, 285));
            girl.Scale(0,854.0f/1400);
            girl.Fade(0,0);
            girl.Fade(29181,1);
            ...
            for(int j = 29181; j <= 43581; j += (int)tick(29181, 0.5)){
                newX = 380+Random(-2.5, 2.5);
                newY = 285+Random(-2.5, 2.5);
                newA = Random(-1.5, 1.5);
            ...
            var rBG = GetLayer("").CreateSprite("sb/girlR.jpg");
            var gBG = GetLayer("").CreateSprite("sb/girlG.jpg");
            var bBG = GetLayer("").CreateSprite("sb/girlB.jpg");

            rBG.Scale(0,854.0f/1529);
            rBG.Fade(0,0);
            rBG.Fade(67581,0.75);
            rBG.Fade(76132,0);

            gBG.Scale(0,854.0f/1529);
            gBG.Fade(0,0);
            gBG.Fade(67581,0.75);
            gBG.Fade(76132,0);
            gBG.Additive(67581,76132);

            bBG.Scale(0,854.0f/1529);
            bBG.Fade(0,0);
            bBG.Fade(67581,0.75);
            bBG.Fade(76132,0);
